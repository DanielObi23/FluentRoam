...
export default function VocabTable({vocab, index}: VocabTable) {
    return (
        <Table key={`vocab-${index}`} className="border-2 border-primary-200 dark:border-primary-900 w-full">
            <TableBody>
                {/* WORD */}
                <TableRow>
                ...
                {/* PART OF SPEECH */}
                <TableRow>
                    <TableCell className="bg-blue-400">
                        Part of Speech
                    </TableCell>
                    <TableCell>
                                    ...
                                    <TableRow key={`example-${index}`} className="space-y-1">
                                        <TableCell>
                                            <Table>
                                                <TableBody>
                                                    <TableRow>
                                                        <TableCell className="bg-secondary-500">Sentence</TableCell>
                                                        <TableCell>{example.sentence}</TableCell>
                                                    </TableRow>
                                                    <TableRow>
                                                        <TableCell className="bg-secondary-500">Translation</TableCell>
                                    ...
                                    <TableRow key={`idiom-${index}`} className="space-y-1">
                                        <TableCell>
                                            <Table>
                                                <TableBody>
                                                    <TableRow>
                                                        <TableCell className="bg-secondary-500">Idiom</TableCell>
                                                        <TableCell>{idiom.phrase}</TableCell>
                                                    </TableRow>
                                                    <TableRow>
                                                        <TableCell className="bg-secondary-500">Meaning</TableCell>
                                    ...
                                    <TableRow key={`variation-${index}`} className="space-y-1">
                                        <TableCell>
                                            <Table>
                                                <TableBody>
                                                    <TableRow>
                                                        <TableCell className="bg-secondary-500">Country</TableCell>
                                                        <TableCell>{variation.country}</TableCell>
                                                    </TableRow>
                                                    <TableRow>
                                                        <TableCell className="bg-secondary-500">Word</TableCell>
                                                        <TableCell>{variation.word}</TableCell>
                                                    </TableRow>
                                                    <TableRow>
                                                        <TableCell className="bg-secondary-500">Part of speech</TableCell>
                                                    ...
                                                    <TableRow>
                                                        <TableCell className="bg-secondary-500">Example Sentence</TableCell>
                                                        <TableCell>{variation.example.sentence}</TableCell>
                                                    </TableRow>
                                                    <TableRow>
                                                        <TableCell className="bg-secondary-500">Translation</TableCell>
                                                        <TableCell>{variation.example.translation}</TableCell>
                                                    </TableRow>
                                                </TableBody>
                                            </Table>
                                        </TableCell>
