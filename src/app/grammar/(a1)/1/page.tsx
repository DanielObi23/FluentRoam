...
export default function Page() {
    ...
    const story1 = [
        ...
        {"speaker": "Ana", "text": "Estoy bien, ¿y tú?"},
        ...
        {"speaker": "Ana", "text": "El gusto es mío"},        
    ]

    return(
        <div className="w-full min-h-screen bg-background">
            <Navigation page="Grammar"/>
            <main className="w-full flex bg-accent p-3">
                <section className="w-5/7 bg-primary overflow-y-auto flex flex-col items-center gap-5" aria-label="The Spanish Alphabet, Pronunciation & Greetings">
                ...
                <section className="w-2/7 flex flex-col items-center bg-secondary">
                    <ul>
